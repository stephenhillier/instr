...
func (ResistanceResponse_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_api_43076ca76c1e7a1f, []int{1, 0}
}

type ResistanceReading struct {
	Resistance           float32  `protobuf:"fixed32,1,opt,name=resistance,proto3" json:"resistance,omitempty"`
...
func (*ResistanceReading) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_43076ca76c1e7a1f, []int{0}
}
...
func (m *ResistanceReading) GetResistance() float32 {
	if m != nil {
		return m.Resistance
	}
	return 0
...
func (*ResistanceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_api_43076ca76c1e7a1f, []int{1}
}
...
func init() { proto.RegisterFile("api.proto", fileDescriptor_api_43076ca76c1e7a1f) }

var fileDescriptor_api_43076ca76c1e7a1f = []byte{
	...
	0x92, 0xe3, 0xe2, 0x2a, 0x82, 0x0b, 0x4a, 0x30, 0x2a, 0x30, 0x6a, 0x30, 0x05, 0x21, 0x89, 0x08,
	...
	0x18, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xbd, 0xdc, 0xab, 0x3e, 0x22, 0x01, 0x00, 0x00,
}
